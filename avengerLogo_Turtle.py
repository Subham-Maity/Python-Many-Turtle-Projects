...
if __name__ == '__main__':
    ...
    code_xam = turtle.Turtle()
    code_xam.speed(10)
    code_xam.pensize(10)
    code_xam.penup()

    draw_circle(code_xam)
    draw_circle2(code_xam)
    draw_A(code_xam)
    draw_triangle(code_xam)
    draw_arrow(code_xam)
    code_xam.penup()

    code_xam.setposition(300,300)
    code_xam.pencolor("red")

    code_xam.write("CodeXam")
    code_xam.hideturtle()
    turtle.done()